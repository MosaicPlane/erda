...
func (e *Endpoints) Routes() []httpserver.Endpoint {
	return []httpserver.Endpoint{
		...
		{Path: "/api/runtimes/{runtimeID}/progressive-releases", Method: http.MethodGet, Handler: e.GetProgressiveReleases},
		{Path: "/api/runtimes/{runtimeID}/progressive-releases", Method: http.MethodPut, Handler: e.ConfigureProgressiveRelease},
		{Path: "/api/runtimes/{runtimeID}/progressive-releases/actions/approve", Method: http.MethodPost, Handler: e.ApproveProgressiveRelease},
		{Path: "/api/runtimes/{runtimeID}/progressive-releases/actions/rollback", Method: http.MethodPost, Handler: e.RollbackProgressiveRelease},
